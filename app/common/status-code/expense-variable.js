module.exports = {
  EXPENSE: {
    EMPTY: {
      ...
      CATEGORY_ID: { MESSAGE: 'Empty Category Id.' },
      CATEGORY: { MESSAGE: 'Empty Category.' },
      CATEGORY_TYPE: { MESSAGE: 'Empty Category type.' },
    },
    EXIST: { CODE: 201, STATUS: true, MESSAGE: 'Category Already Exist.' },
